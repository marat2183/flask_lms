...
admin = admin.Admin(name='Flaks_lms', template_mode='bootstrap4')
...
def create_app():
    ...
    from app.models import fetch_azure_token, update_azure_token
    ...
    from app.models import TeacherUser, Theme, Course, Group, Auditorium, User, load_user
    from app.courses.admin_views import TeacherView, StudentView, CourseView, AuditoriumView, GroupView
